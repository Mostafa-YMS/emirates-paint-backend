...
def changeColor(org_img, new_img, position, color, uploaded, pattern_image = None):
    if uploaded:
        ...
        _, mask = cv2.threshold(gray, 10, 255, 0, cv2.THRESH_BINARY)
        colored_image = getColoredImage(org_img, color, pattern_image)
        final_img = mergeImages(org_img, colored_image, mask)
    return final_img

# changeColor(r'C:\Users\user\Downloads\22.jpg',r'C:\Users\user\Downloads\22.jpg',(300,100),(255,0,0),None)
